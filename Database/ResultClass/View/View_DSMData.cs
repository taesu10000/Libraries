...
{
    [Serializable]
    public class View_DSMDatas
    {
        public int? TotalCount { get; set; }

        public List<View_DSMData> List_DSMData { get; set; }
    }

    [Serializable]
    public class View_DSMData
    {
        ...
        public View_DSMData(object list)
            :this()
        {
        ...
        {
            return DominoFunctions.ClassFunctions.ClassToLocalizationString<View_DSMData>(this);
        }
        
        public View_DSMData Clone()
        {
            return (View_DSMData)this.MemberwiseClone();
        }
    }
}
