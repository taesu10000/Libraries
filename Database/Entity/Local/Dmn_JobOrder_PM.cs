...
namespace DominoDatabase.Local
{
    public class Dmn_JobOrder_PM
    {
        ...
        {
            return DominoFunctions.ClassFunctions.ClassToLocalizationString<Dmn_JobOrder_PM>(this);
        }
        public Dmn_JobOrder_PM()
        {

        }
        public Dmn_JobOrder_PM(object obj)
            : this()
        {
            this.UnionClass(obj);
        }
