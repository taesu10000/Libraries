...
namespace DominoDatabase.DSM
{
    public class Dmn_JobOrder_D
    {
        ...
        {
            return DominoFunctions.ClassFunctions.ClassToLocalizationString<Dmn_JobOrder_D>(this);
        }
        public Dmn_JobOrder_D()
        {

        }
        public Dmn_JobOrder_D(object obj)
            : this()
        {
            this.UnionClass(obj);
        }
